package com.kh.chap2_abstract.part01.model.vo;


// 추상 메서드가 존재하는 순간 반드시 추상 클래스로 정의
public abstract class Sports {
		 ...
		 *  - 추상 메서드를 정의하기 위해선 abstract 예약어를 추가해야한다.
		 *  - 만일 클래스 내부에 추상 메서드가 존재하는 경우, 해당 클래스는 반드시 추상 클래스로 정의해야 한다.
		 *  
		 *  추상 클래스를 사용하는 경우
		 *  - 부모 클래스를 상속하면서 모든 자식 클래스에서 공통으로 구현해야하는 메서드가 존재하는 경우,
