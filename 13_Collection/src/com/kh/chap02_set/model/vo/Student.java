...
public class Student {
			 ...
			 * 1. equals메서드 오버라이딩
			 * 2. hashCode메서드 오버라이딩    (두개 다 해줘야 함)
			 * 
			 * 
			 *  
			 */
			...
			public boolean equuals(Object o) {
				...
				// 매개변수로 전댈받은 객체가 Student 객체가 아닌 경우
			 ...
			 * 	- hashCode는 HashMap, HashSet 등에서 데이터를 저장하기 위한 key값에 사용되는 메서드.
			 * 		hashCode를 오버라이딩하지 않고 equals메서드만 오버라이딩 하게 되면 논리적으로 두 객체는 같음을 판단할 수 있지만
