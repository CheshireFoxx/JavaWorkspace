...
public class Run {
			public static void main(String[] args) {
				 ...
				 * LinkedSet : 중복을 허용하지 않지만, 저장된 순서를 유지한다.
				 * TreeSet : 중복을 허용하지 않지만, 오름차순 정렬(기본값)을 지원.
				 * 
				 * 
				 */
				 ...
				 * 2. 저장한 위치에 이미 저장된 값이 있다면, equals 메서드를 통해 저장된 값과
				 * 새로 추가할 값이 같은지 검사한다.
				...
				// List <--> Set
				// 1. List/Set에 Set/List 계열 데이터를 담는 방법. (매개변수에 초기화)
				ArrayList<Student> list = new ArrayList<>(hs2);
				
				// 2. List에 Set 계열 데이터를 추가하는 방법
				// addAll()
