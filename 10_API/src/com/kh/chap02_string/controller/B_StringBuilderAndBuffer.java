...
public class B_StringBuilderAndBuffer {
			 ...
			 *  - StringBuffer는 동기화를 지원하기 때문에 "멀티 스레드환경"에서 스레드  안정성을 보장할 수 있으나
			 *    성능이 좋지 못하다.
			 *  
			 *  
			 */
	...
	public void method() {
		...
		sb1.append("!!!"); // 주소값 한개만 사용
		
		StringBuffer sb2 = new StringBuffer("hello");
		sb2.append("World");
		
		System.out.println(sb1); // 참조자료형이지만 오버라이딩 된 결과.
		System.out.println(sb2.toString());
		
		System.out.println("문자열의 길이는 ? " + sb1.length());
		System.out.println("문자열에서 o의 마지막 위치는 ? " + sb1.lastIndexOf(str));
