...
public class Run {
				public static void main(String[] args) {
					...
					try {
						...
						// 3) 클라이언트의 접속요청이 들어올 때까지 대기
						while(true) {
							System.out.println("### 클라이언트의 요청 대기 중 ###");
							// 클라이언트의 요청이 들어올 때까지 대기 후, 요청이 들어오면 클라이언트와 통신이 가능한 Socket을 생성
						...
						// 4) 연결된 클아이언트와 통신이 가능한 입출력 스트림 생성하기
