...
public class WebCralwer {
			...
			public void test1() {
				...
				List<String> imgList = new ArrayList<String>(); // img 파일이 존재하는 "경로"를 저장할 컬렉션
			...
			public void saveFile(List<String> imgList) {
				...
				for(String imgPath : imgList) {
					...
					String savePath = "C:/upload/kh/project/"+imgPath;
					...
					try {
						URL url = new URL("http://khedu.co.kr"+fileName);
						URLConnection conn = url.openConnection();						
